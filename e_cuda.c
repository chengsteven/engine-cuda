...
void (*cuda_device_crypt) (cuda_crypt_parameters *crypt);
...
int cuda_finish(ENGINE * engine) {
	cuda_device_finish(host_data,device_data_in);
...
#define cuda_cast5_cbc cuda_cast_cbc
#define cuda_cast_128_cbc cuda_cast_cbc
