...
GNUTERM = "wxt"
plot 'aes-128-cbc-decrypt.dat' using 1 title 'AES 128 CBC GPU' with linespoints,'aes-192-cbc-decrypt.dat' using 1 title 'AES 192 CBC GPU' with linespoint,'aes-256-cbc-decrypt.dat' using 1 title 'AES 256 CBC GPU' with linespoint, 'aes-128-cbc-decrypt-cpu.dat' using 1 title 'AES 128 CBC CPU' with linespoints,'aes-192-cbc-decrypt-cpu.dat' using 1 title 'AES 192 CBC CPU' with linespoint,'aes-256-cbc-decrypt-cpu.dat' using 1 title 'AES 256 CBC CPU' with linespoint
#    EOF
