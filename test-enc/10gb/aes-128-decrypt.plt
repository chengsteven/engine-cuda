...
GNUTERM = "wxt"
plot 'aes-128-ctr-decrypt.dat' using 1 title 'AES 128 CTR GPU' with linespoints,'aes-128-ctr-decrypt-cpu.dat' using 1 title 'AES 128 CTR CPU' with linespoints,'aes-128-ecb-decrypt.dat' using 1 title 'AES 128 ECB GPU' with linespoints,'aes-128-ecb-decrypt-cpu.dat' using 1 title 'AES 128 ECB CPU' with linespoints,'aes-128-cbc-decrypt.dat' using 1 title 'AES 128 CBC GPU' with linespoints,'aes-128-cbc-decrypt-cpu.dat' using 1 title 'AES 128 CBC CPU' with linespoints
#    EOF
