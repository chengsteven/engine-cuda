...
rm table-aes-ctr-enc.csv 2> /dev/null
rm table-aes-ctr-dec.csv 2> /dev/null
#
...
echo "<h1>AES CTR encryption performance</h1>" >> table.html
echo "=AES CTR encryption performance=" > table.wiki
echo ' ' >> table.wiki
echo '<img src="'$HTML_PATH'/aes-ctr-encrypt.png" alt="aes-ctr-encrypt"/>' >> table.html
echo '['$WIKI_PATH'/aes-ctr-encrypt.png]' >> table.wiki
echo ' ' >> table.wiki
echo '<table><tr><th>blocksize</th><th>aes-128-ctr-gpu</th><th>aes-128-ctr-cpu</th><th>aes-192-ctr-gpu</th><th>aes-192-ctr-cpu</th><th>aes-256-ctr-gpu</th><th>aes-256-ctr-cpu</th></tr>' >> table.html
echo '|| *blocksize* || *aes-128-ctr-gpu* || *aes-128-ctr-cpu* || *aes-192-ctr-gpu* || *aes-192-ctr-cpu* || *aes-256-ctr-gpu* || *aes-256-ctr-cpu* ||' >> table.wiki
echo 'blocksize;aes-128-ctr-gpu;aes-128-ctr-cpu;aes-192-ctr-gpu;aes-192-ctr-cpu;aes-256-ctr-gpu;aes-256-ctr-cpu' >> table-aes-ctr-enc.csv
for blocksize in 16 64 256 1024 2048 4096 8192 16384 32768 65536 131072 262144 524288 1048576 2097152 4194304 8388608
	do
	speedGPU_128_ctr=$(cat ./data/aes-128-ctr.dat    |grep ^$blocksize |cut -f 2 -d ' '|head -1)
	speedCPU_128_ctr=$(cat ./data/aes-128-ctr-cpu.dat|grep ^$blocksize |cut -f 2 -d ' '|head -1)
	speedGPU_192_ctr=$(cat ./data/aes-192-ctr.dat    |grep ^$blocksize |cut -f 2 -d ' '|head -1)
	speedCPU_192_ctr=$(cat ./data/aes-192-ctr-cpu.dat|grep ^$blocksize |cut -f 2 -d ' '|head -1)
	speedGPU_256_ctr=$(cat ./data/aes-256-ctr.dat    |grep ^$blocksize |cut -f 2 -d ' '|head -1)
	speedCPU_256_ctr=$(cat ./data/aes-256-ctr-cpu.dat|grep ^$blocksize |cut -f 2 -d ' '|head -1)
	echo '<tr><th>'$blocksize'</th><td>'$speedGPU_128_ctr'</td><td>'$speedCPU_128_ctr'</td><td>'$speedGPU_192_ctr'</td><td>'$speedCPU_192_ctr'</td><td>'$speedGPU_256_ctr'</td><td>'$speedCPU_256_ctr'</td></tr>' >> table.html
	echo '|| *'$blocksize'* || '$speedGPU_128_ctr' || '$speedCPU_128_ctr' || '$speedGPU_192_ctr' || '$speedCPU_192_ctr' || '$speedGPU_256_ctr' || '$speedCPU_256_ctr' ||' >> table.wiki
	echo $blocksize';'$speedGPU_128_ctr';'$speedCPU_128_ctr';'$speedGPU_192_ctr';'$speedCPU_192_ctr';'$speedGPU_256_ctr';'$speedCPU_256_ctr >> table-aes-ctr-enc.csv
	done
echo '</table>' >> table.html
echo '<p>The "numbers" in the column "blocksize" are in bytes.</p>' >> table.html
echo '<p>All other "numbers" are in bytes per second processed.</p>' >> table.html
...
echo "<h1>AES CTR decryption performance</h1>" >> table.html
echo "=AES CTR decryption performance=" >> table.wiki
echo ' ' >> table.wiki
echo '<img src="'$HTML_PATH'/aes-ctr-decrypt.png" alt="aes-ctr-decrypt"/>' >> table.html
echo '['$WIKI_PATH'/aes-ctr-decrypt.png]' >> table.wiki
echo ' ' >> table.wiki
echo '<table><tr><th>blocksize</th><th>aes-128-ctr-gpu</th><th>aes-128-ctr-cpu</th><th>aes-192-ctr-gpu</th><th>aes-192-ctr-cpu</th><th>aes-256-ctr-gpu</th><th>aes-256-ctr-cpu</th></tr>'  >> table.html
echo '|| *blocksize* || *aes-128-ctr-gpu* || *aes-128-ctr-cpu* || *aes-192-ctr-gpu* || *aes-192-ctr-cpu* || *aes-256-ctr-gpu* || *aes-256-ctr-cpu* ||' >> table.wiki
echo 'blocksize;aes-128-ctr-gpu;aes-128-ctr-cpu;aes-192-ctr-gpu;aes-192-ctr-cpu;aes-256-ctr-gpu;aes-256-ctr-cpu' >> table-aes-ctr-dec.csv
for blocksize in 16 64 256 1024 2048 4096 8192 16384 32768 65536 131072 262144 524288 1048576 2097152 4194304 8388608
	do
	speedGPU_128_ctr=$(cat ./data/aes-128-ctr-decrypt.dat    |grep ^$blocksize |cut -f 2 -d ' '|head -1)
	speedCPU_128_ctr=$(cat ./data/aes-128-ctr-decrypt-cpu.dat|grep ^$blocksize |cut -f 2 -d ' '|head -1)
	speedGPU_192_ctr=$(cat ./data/aes-192-ctr-decrypt.dat    |grep ^$blocksize |cut -f 2 -d ' '|head -1)
	speedCPU_192_ctr=$(cat ./data/aes-192-ctr-decrypt-cpu.dat|grep ^$blocksize |cut -f 2 -d ' '|head -1)
	speedGPU_256_ctr=$(cat ./data/aes-256-ctr-decrypt.dat    |grep ^$blocksize |cut -f 2 -d ' '|head -1)
	speedCPU_256_ctr=$(cat ./data/aes-256-ctr-decrypt-cpu.dat|grep ^$blocksize |cut -f 2 -d ' '|head -1)
	echo '<tr><th>'$blocksize'</th><td>'$speedGPU_128_ctr'</td><td>'$speedCPU_128_ctr'</td><td>'$speedGPU_192_ctr'</td><td>'$speedCPU_192_ctr'</td><td>'$speedGPU_256_ctr'</td><td>'$speedCPU_256_ctr'</td></tr>' >> table.html
	echo '|| *'$blocksize'* || '$speedGPU_128_ctr' || '$speedCPU_128_ctr' || '$speedGPU_192_ctr' || '$speedCPU_192_ctr' || '$speedGPU_256_ctr' || '$speedCPU_256_ctr' ||' >> table.wiki
	echo $blocksize';'$speedGPU_128_ctr';'$speedCPU_128_ctr';'$speedGPU_192_ctr';'$speedCPU_192_ctr';'$speedGPU_256_ctr';'$speedCPU_256_ctr >> table-aes-ctr-dec.csv
	done
echo '</table>' >> table.html
echo '<p>The "numbers" in the column "blocksize" are in bytes.</p>' >> table.html
echo '<p>All other "numbers" are in bytes per second processed.</p>' >> table.html
