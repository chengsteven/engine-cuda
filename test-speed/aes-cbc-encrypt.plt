...
GNUTERM = "wxt"
plot './data/aes-128-cbc.dat' using 2 title 'AES 128 CBC GPU' with linespoints,'./data/aes-192-cbc.dat' using 2 title 'AES 192 CBC GPU' with linespoint,'./data/aes-256-cbc.dat' using 2 title 'AES 256 CBC GPU' with linespoint,'./data/aes-128-cbc-cpu.dat' using 2 title 'AES 128 CBC CPU' with linespoints,'./data/aes-192-cbc-cpu.dat' using 2 title 'AES 192 CBC CPU' with linespoint,'./data/aes-256-cbc-cpu.dat' using 2 title 'AES 256 CBC CPU' with linespoint
#    EOF
